                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control @error('patient_mr')
                                    is-invalid
                                @enderror" name="patient_mr" value="{{ $autorm }}" placeholder="Medical Record Number"
                                    readonly required>
                                @error('patient_mr')
                            ...
                            <div class="col-sm-6 mt-0">
                                <div class="form-text text-muted">Medical Record Number is autogenerate from system and
                                    must
                                    be unique with 6 digits number.</div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4 mt-2">
                                <input type="text" class="form-control @error('patient_nik')
                                    is-invalid
                                @enderror" name="patient_nik" value="{{ old('patient_nik') }}" id="patient_nik"
                                    placeholder="Patient NIK Number"
                            ...
                            <div class="col-sm-2 mt-2">
                                <input type="text" class="form-control" name="patient_ihs"
                                    value="{{ old('patient_ihs') }}" id="patient_ihs" placeholder="SATUSEHAT ID">
                            </div>
                            <div class="col-sm-2 mt-2">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2 mt-2">
                                <select class="form-control" name="patient_title" value="{{ old('patient_title') }}"
                                    required>
                            ...
                            <div class="col-sm-4 mt-2">
                                <input type="text" onkeyup="this.value = this.value.toUpperCase();" class="form-control @error('patient_name')
                                    is-invalid
                                @enderror" name="patient_name" value="{{ old('patient_name') }}" id="patient_name"
                            ...
                            <div class="col-sm-2 mt-2">
                                <select class="form-control" name="patient_gender" value="{{ old('patient_gender') }}"
                                    required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4 mt-2">
                                <input type="text" class="form-control @error('patient_birthplace')
                                    is-invalid
                                @enderror" name="patient_birthplace" value="{{ old('patient_birthplace') }}"
                                    placeholder="Birth Place" onkeyup="this.value = this.value.toUpperCase();" required>
                            ...
                            <div class="col-sm-4 mt-2">
                                <input type="date" class="form-control @error('patient_birthdate')
                                    is-invalid
                                @enderror" name="patient_birthdate" value="{{ old('patient_birthdate') }}"
                                    id="patient_birthdate" placeholder="Birth Date" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10 mt-2">
                                <textarea class="form-control" name="patient_address_line"
                                    value="{{ old('patient_address_line') }}" placeholder="Address"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2 mt-2">
                                <select name="patient_code_province" value="{{ old('patient_code_province') }}"
                            ...
                            <div class="col-sm-2 mt-2">
                                <select name="patient_code_city" value="{{ old('patient_code_city') }}"
                                    class="form-control" id="kota" required>
                                    <option value="">- Select City -</option>
                                    <option value="">Select Province First</option>
                                </select>
                            </div>
                            <div class="col-sm-2 mt-2">
                                <select name="patient_code_district" value="{{ old('patient_code_district') }}"
                            ...
                            <div class="col-sm-2 mt-2">
                                <select name="patient_code_village" value="{{ old('patient_code_village') }}"
                            ...
                            <div class="col-sm-1 mt-2">
                                <input type="text" class="form-control @error('patient_code_rt')
                                    is-invalid
                                @enderror" name="patient_code_rt" value="{{ old('patient_code_rt') }}" placeholder="RT"
                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1')"
                            ...
                            <div class="col-sm-1 mt-2">
                                <input type="text" class="form-control @error('patient_code_rw')
                                    is-invalid
                                @enderror" name="patient_code_rw" value="{{ old('patient_code_rw') }}" placeholder="RW"
                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1')"
                                    minlength="1" maxlength="3" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control @error('patient_telecom')
                                    is-invalid
                                @enderror" name="patient_telecom" value="{{ old('patient_telecom') }}"
                            ...
                            <div class="col-sm-4">
                                <input type="mail" class="form-control @error('patient_email')
                                    is-invalid
                                @enderror" name="patient_email" value="{{ old('patient_email') }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4 mt-2">
                                <select class="form-control" name="patient_religion"
                                    value="{{ old('patient_religion') }}" required>
                            ...
                            <div class="col-sm-4 mt-2">
                                <select class="form-control" name="patient_bloodtype"
                                    value="{{ old('patient_bloodtype') }}" required>
                                    <option value="">- Select -</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4 mt-2">
                                <select class="form-control" name="patient_profession"
                                    value="{{ old('patient_profession') }}" required>
                                    <option value="">- Select -</option>
                                    ...
                                    <option value="Petugas SPBU">Petugas SPBU</option>
                                    <option value="Pilot">Pilot</option>
                                    <option value="PNS">PNS</option>
                                    <option value="Polisi">Polisi</option>
                                    <option value="Polisi Pamong Praja">Polisi Pamong Praja</option>
                            ...
                            <div class="col-sm-4 mt-2">
                                <select class="form-control" name="patient_marital_status"
                                    value="{{ old('patient_marital_status') }}" required>
                                    <option value="">- Select -</option>
                    ...
                    <div class="card-header" id="patient_companion_subtitle" style="display: none">
                        <h10>Name and Phone of Patient Companion must be filled if patient is less than 17 years old.
                        </h10>
                    </div>
                    <div class="card-body" id="patient_companion_form" style="display: none">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4 mt-2">
                                <input type="text" onkeyup="this.value = this.value.toUpperCase();" class="form-control @error('patient_relationship_name')
                                    is-invalid
                                @enderror" name="patient_relationship_name"
                                    value="{{ old('patient_relationship_name') }}" placeholder="Full Name">
                            ...
                            <div class="col-sm-4 mt-2">
                                <input type="text"
                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1')"
                                    class="form-control @error('patient_relationship_phone')
                                        is-invalid
                                    @enderror" name="patient_relationship_phone"
                                    value="{{ old('patient_relationship_phone') }}" placeholder="Phone Number"
                    ...
                    <input type="hidden" name="patient_address_city" value="{{ old('patient_address_city') }}"
                        id="patient_address_city">
                    <input type="hidden" name="patient_identifier" value="nik">
                    <input type="hidden" name="patient_address_extension" value="{{ old('patient_address_extension') }}"
                        id="kodewilayah">
            ...
            $('#validate').click(function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data[1].total ==
                            1) { //CEK APAKAH DATA RESOURCE ADA, cek console.log
                            $('#patient_status_value').val("active");
                            $('#patient_ihs').val(data[1].entry[0].resource.id);
                            // $('#patient_name').val(data[1].entry[0].resource.name[0].text);
                            document.getElementById('patient_status_error').style.display =
                                'none';
                            document.getElementById('validate').style.display = 'none';
                            document.getElementById("patient_status_success").textContent =
                                "IHS Data Successfully Validated";
                            document.getElementById('patient_status_success').style
                                .display = 'block';
                            document.getElementById('patient_name').value = data[1].entry[0]
                                .resource
                                .name[0].text;
                            console.log(data);
                            ...
                            document.getElementById('patient_status_success').style
                                .display = 'none';
                            document.getElementById("patient_status_error").textContent =
                                "NIK Not Found on IHS Data.";
                            document.getElementById('patient_status_error').style.display =
                                'block';
                            $('#patient_ihs').val("0");
                            console.log(data);
                        ...
                        success: function (data) {
                            if (data) {
                                ...
                                $.each(data, function (code, kota) {
                                    $('select[name="patient_code_city"]').append(
                        ...
                        success: function (data) {
                            if (data) {
                                ...
                                $.each(data, function (code, kecamatan) {
                                    $('select[name="patient_code_district"]')
                        ...
                        success: function (data) {
                            if (data) {
                                ...
                                $.each(data, function (code, kelurahan) {
                                    $('select[name="patient_code_village"]').append(
                        ...
                        success: function (data) {
                            if (data) {
                                ...
                                $.each(data, function (code, patient_address_city) {
                                    document.getElementById('patient_address_city')
                                        .value = patient_address_city.name;
                                });
                            } else {
                                $('#patient_address_city').empty();
                            }
