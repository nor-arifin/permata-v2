                        ...
                        <div class="card">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2 mt-2">
                                        <div class="input-group">
                                            <input type="text" name="test_loinc_code" value="{{ $laboratory->test_loinc_code }}" id="test_loinc_code" class="form-control" placeholder="Code" aria-label="">
                                            <div class="input-group-append">
                                                <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#modal-loinc"><i class="fas fa-search d-none d-sm-inline"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-7 mt-2">
                                        <input type="text" class="form-control @error('test_loinc_display')
                                            is-invalid
                                        @enderror" name="test_loinc_display" value="{{ $laboratory->test_loinc_display }}" id="test_loinc_display" placeholder="LOINC Display" required readonly>
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10 mt-2">
                                        <input type="text" class="form-control @error('test_code')
                                            is-invalid
                                        @enderror" name="test_code" onkeyup="this.value = this.value.toUpperCase();" value="{{ $laboratory->test_code }}" id="test_code" placeholder="Unique 3 Digit Alfabetic Code" minlength="3" maxlength="3" required>
                                        @error('test_code')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control @error('test_name')
                                            is-invalid
                                        @enderror" name="test_name" id="test_name" value="{{ $laboratory->test_name }}" placeholder="Test Name" required>
                                        @error('test_name')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <select name="test_group" value="{{ old('test_group') }}" class="form-control" id="test_group" required>
                                            <option value="{{ $laboratory->test_group }}">{{ $laboratory->test_group }}</option>
                                    ...
                                    <div class="col-sm-4">
                                        <select name="test_subgroup" value="{{ old('test_subgroup') }}" class="form-control" id="test_subgroup" required>
                                            <option value="{{ $laboratory->test_subgroup }}">{{ $laboratory->test_subgroup }}</option>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Speciment Type</label>
                                    <div class="col-sm-4">
                                        <select name="test_specimen" value="{{ old('test_specimen') }}" class="form-control" id="test_specimen" required>
                                            <option value="{{ $laboratory->test_specimen }}">{{ $laboratory->test_specimen }}</option>
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control @error('test_method')
                                            is-invalid
                                        @enderror" name="test_method" id="test_method" value="{{ $laboratory->test_method }}" placeholder="Test Method" required>
                                        @error('test_method')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <select name="test_resulttype" value="{{ $laboratory->test_resulttype }}" class="form-control" id="test_resulttype" required>
                                            <option value="{{ $laboratory->test_resulttype }}">{{ $laboratory->test_resulttype }}</option>
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control @error('test_unit')
                                            is-invalid
                                        @enderror" name="test_unit" id="test_unit" value="{{ $laboratory->test_unit }}" placeholder="Unit of Measure">
                                        @error('test_method')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-1">
                                            <label>Minimum</label>
                                            <input type="text" name="test_min_general" value="{{ $laboratory->test_min_general }}" id="test_min_general" class="form-control">
                                        </div>
                                        <div class="form-group col-md-1">
                                            <label>Maximum</label>
                                            <input type="text" name="test_max_general" value="{{ $laboratory->test_max_general }}" id="test_max_general" class="form-control">
                                        </div>
                                        <div class="form-group col-md-1">
                                            <label>Unit</label>
                                            <input type="text" name="test_unit_general" value="{{ $laboratory->test_unit }}" id="test_unit_general" class="form-control" readonly>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label>Normal Value Display</label>
                                            <input type="text" name="test_normal_general" value="{{ $laboratory->test_normal_general }}" id="test_normal_general" class="form-control" readonly>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-3">
                                        ...
                                        <div class="form-group col-md-1">
                                            <input type="text" name="test_min_male" value="{{ $laboratory->test_min_male }}" id="test_min_male" class="form-control">
                                        </div>
                                        <div class="form-group col-md-1">
                                            <input type="text" name="test_max_male" value="{{ $laboratory->test_max_male }}" id="test_max_male" class="form-control">
                                        </div>
                                        <div class="form-group col-md-1">
                                            <input type="text" name="test_unit_male" value="{{ $laboratory->test_unit }}" id="test_unit_male" class="form-control" readonly>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <input type="text" name="test_normal_male" value="{{ $laboratory->test_normal_male }}" id="test_normal_male" class="form-control" readonly>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-3">
                                        ...
                                        <div class="form-group col-md-1">
                                            <input type="text" name="test_min_female" value="{{ $laboratory->test_min_female }}" id="test_min_female" class="form-control">
                                        </div>
                                        <div class="form-group col-md-1">
                                            <input type="text" name="test_max_female" value="{{ $laboratory->test_max_female }}" id="test_max_female" class="form-control">
                                        </div>
                                        <div class="form-group col-md-1">
                                            <input type="text" name="test_unit_female" value="{{ $laboratory->test_unit }}" id="test_unit_female" class="form-control" readonly>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <input type="text" name="test_normal_female" value="{{ $laboratory->test_normal_female }}" id="test_normal_female" class="form-control" readonly>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-3">
                                        ...
                                        <div class="form-group col-md-1">
                                            <input type="text" name="test_min_child" value="{{ $laboratory->test_min_child }}" id="test_min_child" class="form-control">
                                        </div>
                                        <div class="form-group col-md-1">
                                            <input type="text" name="test_max_child" value="{{ $laboratory->test_max_child }}" id="test_max_child" class="form-control">
                                        </div>
                                        <div class="form-group col-md-1">
                                            <input type="text" name="test_unit_child" value="{{ $laboratory->test_unit }}" id="test_unit_child" class="form-control" readonly>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <input type="text" name="test_normal_child" value="{{ $laboratory->test_normal_child }}" id="test_normal_child" class="form-control" readonly>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-3">
                                        ...
                                        <div class="form-group col-md-1">
                                            <input type="text" name="test_min_baby" value="{{ $laboratory->test_min_baby }}" id="test_min_baby" class="form-control">
                                        </div>
                                        <div class="form-group col-md-1">
                                            <input type="text" name="test_max_baby" value="{{ $laboratory->test_max_baby }}" id="test_max_baby" class="form-control">
                                        </div>
                                        <div class="form-group col-md-1">
                                            <input type="text" name="test_unit_baby" value="{{ $laboratory->test_unit_baby }}" id="test_unit_baby" class="form-control" readonly>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <input type="text" name="test_normal_baby" value="{{ $laboratory->test_normal_baby }}" id="test_normal_baby" class="form-control" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-9">
                                            ...
                                            <select name="test_normal_general_ord" value="{{ old('test_normal_general_ord') }}" class="form-control" id="test_normal_general_ord">
                                                <option value="{{ $laboratory->test_normal_general }}">{{ $laboratory->test_normal_general }}</option>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-9">
                                            <select name="test_normal_male_ord" value="{{ old('test_normal_male_ord') }}" class="form-control" id="test_normal_male_ord">
                                                <option value="{{ $laboratory->test_normal_male }}">{{ $laboratory->test_normal_male }}</option>
                                                <option value="Negative">Negative</option>
                                                <option value="Positive">Positive</option>
                                                <option value="Reactive">Reactive</option>
                                                <option value="Non Reactive">Non Reactive</option>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-9">
                                            <select name="test_normal_female_ord" value="{{ old('test_normal_female_ord') }}" class="form-control" id="test_normal_female_ord">
                                                <option value="{{ $laboratory->test_normal_female }}">{{ $laboratory->test_normal_female }}</option>
                                                <option value="Negative">Negative</option>
                                                <option value="Positive">Positive</option>
                                                <option value="Reactive">Reactive</option>
                                                <option value="Non Reactive">Non Reactive</option>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-9">
                                            <select name="test_normal_child_ord" value="{{ old('test_normal_child_ord') }}" class="form-control" id="test_normal_child_ord">
                                                <option value="{{ $laboratory->test_normal_child }}">{{ $laboratory->test_normal_child }}</option>
                                                <option value="Negative">Negative</option>
                                                <option value="Positive">Positive</option>
                                                <option value="Reactive">Reactive</option>
                                                <option value="Non Reactive">Non Reactive</option>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-9">
                                            <select name="test_normal_baby_ord" value="{{ old('test_normal_baby_ord') }}" class="form-control" id="test_normal_baby_ord">
                                                <option value="{{ $laboratory->test_normal_baby }}">{{ $laboratory->test_normal_baby }}</option>
                                                <option value="Negative">Negative</option>
                                                <option value="Positive">Positive</option>
                                                <option value="Reactive">Reactive</option>
                                                <option value="Non Reactive">Non Reactive</option>
                            ...
                            <div class="card-body" id="Other" style="display: none">
                                <div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-9">
                                            <label>Normal Value</label>
                                            <input type="text" name="test_normal_general_other" value="{{ $laboratory->test_normal_general }}" id="test_normal_general_other" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-3">
                                        ...
                                        <div class="form-group col-md-9">
                                            <input type="text" name="test_normal_male_other" value="{{ $laboratory->test_normal_male }}" id="test_normal_male_other" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-3">
                                        ...
                                        <div class="form-group col-md-9">
                                            <input type="text" name="test_normal_female_other" value="{{ $laboratory->test_normal_female }}" id="test_normal_female_other" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-3">
                                        ...
                                        <div class="form-group col-md-9">
                                            <input type="text" name="test_normal_child_other" value="{{ $laboratory->test_normal_child }}" id="test_normal_child_other" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-3">
                                        ...
                                        <div class="form-group col-md-9">
                                            <input type="text" name="test_normal_baby_other" value="{{ $laboratory->test_normal_baby }}" id="test_normal_baby_other" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <select name="test_category" value="{{ old('test_category') }}" class="form-control" id="test_category" required>
                                            <option value="{{ $laboratory->test_category }}">{{ $laboratory->test_category }}</option>
                                    ...
                                    <div class="col-sm-4"  id="partofform">
                                        ...
                                        is-invalid @enderror">
                                            <option value="{{ $laboratory->test_partof }}">{{ $laboratory->test_partof }}</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <select name="test_active" value="{{ old('test_active') }}" class="form-control" id="test_active" required>
                                            <option value="{{ $laboratory->test_active }}">{{ ucfirst($laboratory->test_active) }}</option>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group mb-2">
                                            ...
                                            is-invalid
                                            @enderror" name="test_price" id="test_price" value="{{ $laboratory->test_price }}" placeholder="15000" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*?)\..*/g, '$1')" required>
                                            @error('test_price')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
...
<script type="text/javascript">
    $(document).ready( function () {
        $('#datatables').DataTable({
                ...
                columns: [
                    { data: 'loinc_code', name: 'loinc_code', orderable: false, searchable: true},
                    { data: 'loinc_display', name: 'loinc_display', className: 'text-left', orderable: false, searchable: true},
                    { data: 'loinc_component', name: 'loinc_component', className: 'text-left', orderable: false, searchable: true},
                    { data: 'loinc_method', name: 'loinc_method', className: 'text-left', orderable: false, searchable: true},
...
<script>
    ...
    const titleCaseValue = inputValue.replace(/\w\S*/g, (txt) => txt.charAt(0).toUpperCase() + txt.substr(1).toLowerCase());
    ...
    $(document).ready(function()
        {
            $('#test_max_general').change(function()
            {
                ...
                if(test_max_general != "" && test_min_general != ""){
                    document.getElementById('test_normal_general').value = test_min_general + to + test_max_general;
                }else{
    ...
    $(document).ready(function()
        {
            $('#test_max_female').change(function()
            {
                ...
                if(test_max_female != "" && test_min_female != ""){
                    document.getElementById('test_normal_female').value = test_min_female + to + test_max_female;
                }else{
    ...
    $(document).ready(function()
        {
            $('#test_max_child').change(function()
            {
                ...
                if(test_max_child != "" && test_min_child != ""){
                    document.getElementById('test_normal_child').value = test_min_child + to + test_max_child;
                }else{
