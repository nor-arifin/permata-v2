                ...
                <div class="card-body">
                            ...
                            <div class="accordion-body collapse" id="panel-body-1" data-parent="#accordion">
                                ...
                                <div class="table-responsive">
                                    <table class="table-striped table" id="hematology">
                                        ...
                                        @endphp
                                        @if ($age > 12 && $age <= 100) @if ($gender=='male' ) @php $reference=$input->
                                            test_normal_male;
                                            @endphp
                                            ...
                                            @endphp
                                            @endif
                                            @elseif ($age > 1 && $age <= 12) @php $reference=$input->test_normal_child;
                                                @endphp
                                                @elseif ($age <= 1) @php $reference=$input->test_normal_baby;
                                                    @endphp
                                                    @else
                                                    @php
                                                    ...
                                                    <tr>
                                                        ...
                                                        @if($input->test_category == 'Panel')
                                                        <td class="text-center"></td>
                                                        <td class="text-center"></td>
                                                        <td class="text-center">
                                                            @if($input->service_reference != 'Terlampir')
                                                            {{-- FORM LOAD AND SUBMIT SUB PANEL TEST BY THIS PANEL --}}
                                                            <form
                                                                action="{{ route('lab.generate', $visit->visit_registration_id) }}"
                                                                method="POST">
                                                                @csrf
                                                                <input type="hidden" name="testcode"
                                                                    value="{{ $input->test_code }}">
                                                                <button type="submit"
                                                        ...
                                                        @elseif($input->test_category != 'Panel')
                                                        <td class="text-center">
                                                            <form action="" method="POST" id="entryHematology">
                                                                ...
                                                                <input type="hidden" name="id" value="{{ $input->id }}"
                                                                    id="id_data">
                                                                @if ($input->test_resulttype == 'Ord' ||
                                                                $input->test_resulttype == 'Nom')
                                                                <select name="service_result"
                                                                    id="serviceResultHematology_{{ $input->id }}"
                                                                    class="form-control serviceResultHematology"
                                                                    required>
                                                                    <option value="">-Select-</option>
                                                                    @php
                                                                    $answers =
                                                                    \DB::table('loinc_answers')->where('loinc_code',
                                                                    $input->test_loinc_code)->pluck('answer_display_text');
                                                                    @endphp
                                                                    @foreach ($answers as $answer)
                                                                    <option value="{{ $answer }}" @selected($input->
                                        ...
                                        @if ($age > 12 && $age <= 100) @if ($gender=='male' ) @php $reference=$input->
                                            ...
                                            @elseif ($age > 1 && $age <= 12) @php $reference=$input->test_normal_child;
                                                ...
                                                @elseif ($age <= 1) @php $reference=$input->test_normal_baby;
                                                    ...
                                                    <tr>
                                                        @if($input->test_category == 'Panel')
                                                        <td><b>{{ $input->service_name }}</b></td>
                                                        @elseif($input->test_category == 'Sub Panel')
                                                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ $input->service_name }}
                                                        </td>
                                                        @else
                                                        <td>{{ $input->service_name }}</td>
                                                        @endif
                                                        ...
                                                        <td class="text-center">
                                                            <form action="" method="POST" id="entryBiochemistry">
                                                                ...
                                                                $input->test_resulttype == 'Nom')
                                                                <select name="service_result"
                                                                    id="serviceResultBiochemistry_{{ $input->id }}"
                                                                    class="form-control serviceResultBiochemistry"
                                                                    required>
                                                                    <option value="">-Select-</option>
                                                                    @php
                                                                    $answers =
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <form action="" method="POST" id="entryImmunology">
                                                                ...
                                                                $input->test_resulttype == 'Nom')
                                                                <select name="service_result"
                                                                    id="serviceResultImmunology_{{ $input->id }}"
                                                                    class="form-control serviceResultImmunology"
                                                                    required>
                                                                    <option value="">-Select-</option>
                                                                    @php
                                                                    $answers =
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <form action="" method="POST" id="entryMicrobiology">
                                                                ...
                                                                $input->test_resulttype == 'Nom')
                                                                <select name="service_result"
                                                                    id="serviceResultMicrobiology_{{ $input->id }}"
                                                                    class="form-control serviceResultMicrobiology"
                                                                    required>
                                                                    <option value="">-Select-</option>
                                                                    @php
                                                                    $answers =
                                                        ...
                                                        <td class="text-center">
                                                            <form action="" method="POST" id="entryUrinology">
                                                                ...
                                                                <input type="hidden" name="service_handler"
                                                                    ...
                                                                    id="service_handler">
                                                                <input type="hidden" name="id" value="{{ $input->id }}"
                                                                    id="id_data">@if ($input->test_resulttype == 'Ord'
                                                                ||
                                                                $input->test_resulttype == 'Nom')
                                                                <select name="service_result"
                                                                    id="serviceResultUrinology_{{ $input->id }}"
                                                                    class="form-control serviceResultUrinology"
                                                                    required>
                                                                    <option value="">-Select-</option>
                                                                    @php
                                                                    $answers =
                                                        ...
                                                        <td class="text-center">
                                                            <form action="" method="POST" id="entryBacteriology">
                                                                ...
                                                                <input type="hidden" name="service_handler"
                                                                    ...
                                                                    id="service_handler">
                                                                <input type="hidden" name="id" value="{{ $input->id }}"
                                                                    id="id_data"><input type="hidden" name="id"
                                                                    value="{{ $input->id }}" id="id_data">
                                                                @if ($input->test_resulttype == 'Ord'
                                                                ||
                                                                $input->test_resulttype == 'Nom')
                                                                <select name="service_result"
                                                                    id="serviceResultBacteriology_{{ $input->id }}"
                                                                    class="form-control serviceResultBacteriology"
                                                                    required>
                                                                    <option value="">-Select-</option>
                                                                    @php
                                                                    $answers =
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <form action="" method="POST" id="entryOther">
                                                                ...
                                                                $input->test_resulttype == 'Nom')
                                                                <select name="service_result"
                                                                    id="serviceResultOther_{{ $input->id }}"
                                                                    class="form-control serviceResultOther" required>
                                                                    <option value="">-Select-</option>
                                                                    @php
                                                                    $answers =
                                                                    \DB::table('loinc_answers')->where('loinc_code',
                    ...
                    <div class="row">
                        <div class="col-12 text-right">
                            <button href="#" class="btn btn-success mt-2 mb-2" data-toggle="modal"
                                data-target="#saveModal">Save All Result</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>The entered results <b class="text-danger">cannot be changed</b> and will be verified and validated
                    by the validator. Click save if you are sure the laboratory results have been entered correctly.</p>
            </div>
            <div class="modal-footer bg-whitesmoke br">
                <form action="{{ route('lab.updateresult', $visit->visit_registration_id) }}" method="POST"
                    class="ml-2">
    ...
    $(document).ready(function () {
        ...
        $('#hematology tr').each(function () {
            ...
            input_result.on('change', function () {
                var result = $(this).val();
                console.log('ID:' + id, 'reference:' + reference, 'result:' +
                    result); //INI YA ? iyaa mas betul biar tau data yang diinput
                if (result) {
                    $.ajax({
                        url: '/entryresult',
                        type: "POST",
                        ...
                        success: function (data) {
                            ...
                            Swal.fire({
                                icon: 'success',
                                title: 'Success',
                                text: 'Result has been saved successfully!',
                                timer: 500,
