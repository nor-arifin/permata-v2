                                        ...
                                        <div class="table-responsive">
                                            <table class="table-striped table" id="hematology">
                                                ...
                                                @foreach ($hematology as $input)
                                                    ...
                                                    @endif
                                                    {{-- EDITING --}}
                                                    @if ($input->test_category == 'Panel' && $input->service_reference != 'Terlampir')
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <form action="{{ route('lab.generate', $visit->visit_registration_id) }}" method="POST">
                                                                @csrf
                                                                <input type="hidden" name="testcode" value="{{ $input->test_code }}">
