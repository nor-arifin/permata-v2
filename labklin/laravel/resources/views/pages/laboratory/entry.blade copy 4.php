                                                        ...
                                                        <td class="text-center">
                                                            <form action="" method="POST" id="entryImmunology">
                                                                ...
                                                                <input type="hidden" name="id" value="{{ $input->id }}"
                                                                    id="id_data">
                                                                @if (
                                                                $reference == "Reactive" || $reference == "Non
                                                                Reactive"
                                                                )
                                                                <select name="service_result"
                                                                    id="serviceResultImmunology" class="form-control"
                                                                    required>
                                                                    <option value="">-Select-</option>
                                                                    <option value="Reactive"
                                                                        {{ $input->service_result == 'Reactive' ? 'selected' : '' }}>
                                                                        Reactive</option>
                                                                    <option value="Non Reactive"
                                                                        {{ $input->service_result == 'Non Reactive' ? 'selected' : '' }}>
                                                                        Non Reactive</option>
                                                                </select>
                                                                @elseif (
                                                                ...
                                                                <select name="service_result"
                                                                    ...
                                                                    <option value="Positive"
                                                                        {{ $input->service_result == 'Positive' ? 'selected' : '' }}>
                                                                        Positive</option>
                                                                    <option value="Negative"
                                                                        {{ $input->service_result == 'Negative' ? 'selected' : '' }}>
                                                                        Negative</option>
                                                                </select>
                                                                @else
                                                                <input type="text" class="form-control mt-3"
