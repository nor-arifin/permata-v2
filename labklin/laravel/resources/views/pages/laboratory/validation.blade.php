                                    ...
                                    <table class="table-striped table">
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td style="white-space: nowrap;">
                                                <a href='{{ route('lab.viewvalidation', $lab->service_visit_registration_id) }}' data-toggle="tooltip"
                                                    data-placement="top" title="Validation" class="btn btn-sm btn-info btn-icon ml-2">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                            </td>
                                        </tr>
