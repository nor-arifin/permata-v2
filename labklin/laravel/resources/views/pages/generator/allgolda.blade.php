                                        ...
                                        @foreach ($allgolda as $item)
                                            <tr class="text-center">
                                                ...
                                                <td style="white-space: nowrap;">
                                                    <a href='{{ route('gen.golda', $item->service_visit_registration_id) }}'
                                                        data-toggle="tooltip" data-placement="top" title="Print Golda Card"
