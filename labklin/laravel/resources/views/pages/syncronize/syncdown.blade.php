    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Syncronize to Local</div>
            </div>
        </div>
        <div class="section-body">
            ...
            {{-- FORM --}}
            <form action="{{ route('merge.syncdown') }}" method="GET">
            <div class="row">
                ...
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div>
                                <p>The data synchronization process will transfer and align data <b>from the cloud system to the local</b>. The data to be synchronized includes all data created or modified in the local system. Please ensure that all data has been verified before proceeding with the synchronization process.</p>
                                <p><b>Terms and Conditions:</b></p>
                                <p>
                                    <li>The data synchronization process will transfer and align data <b>from the cloud system to the local</b>.</li>
                                    ...
                                    <li>After clicking the button "Syncronize to Local", the process will start and cannot be terminated. The data will be transferred and aligned to the cloud. Please do not close the browser or tab until the process is complete.</li>
                                </p>
                            </div>
                            ...
                            <div class="form-group mb-0">
                                ...
                                <button class="btn btn-primary" type="submit">Syncronize to Local</button>
                                </div>
                            </div>
                        </div>
                    </div>
