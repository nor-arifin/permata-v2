...
foreach ($samples as $sample) {
    ...
    foreach ($parameters as $parameter) {
        ...
        Fpdf::Cell(48, 12, $parameter->order_parameter_method, 1, 0, 'L');
        Fpdf::Cell(20, 12, $parameter->order_parameter_unit, 1, 0, 'C');
        if ($collector === 'Laboratorium') {
            Fpdf::Cell(30, 12, $parameter->order_parameter_reference_value, 1, 0, 'C');
            Fpdf::Cell(30, 12, $parameter->order_parameter_result, 1, 1, 'C');
        } else {
            Fpdf::Cell(60, 12, $parameter->order_parameter_result, 1, 1, 'C');
        }
    }
