    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Input Payment - {{ $order->order_type }}</h1>
            ...
            <div class="section-body">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-12 col-lg-12">
                                <form action="{{ route('payment.paykm', $order->idcode) }}" method="POST">
                                    @csrf
                                    @method('GET')
                                    <div class="card">
                                        <div class="card-header d-flex justify-content-between align-items-center">
...
<script>
    function showDiv(select) {
        if (select.value == "Credit Card") {
            ...
            document.getElementById('pks').style.display = "none";
            document.getElementById('mou_number').required = false;
        } else if (select.value == "PKS") {
            document.getElementById('credit_card').style.display = "none";
            document.getElementById('debit_card').style.display = "none";
            document.getElementById('transfer').style.display = "none";
            document.getElementById('pks').style.display = "block";
            //Make id="mou_number" required
            document.getElementById('mou_number').required = true;
        } else {
            document.getElementById('credit_card').style.display = "none";
            document.getElementById('debit_card').style.display = "none";
            document.getElementById('transfer').style.display = "none";
