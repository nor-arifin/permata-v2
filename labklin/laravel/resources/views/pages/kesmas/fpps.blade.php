...
Fpdf::SetFont('Arial', '', 10);
Fpdf::SetX(63);
Fpdf::Cell(137, 8, indonesianDatefull(date('d F Y H:i', strtotime($kesmas->order_collect))), 1, 1, 'L');
Fpdf::SetX(63);
Fpdf::Cell(137, 8, indonesianDatefull(date('d F Y H:i', strtotime($kesmas->order_receive))), 1, 1, 'L');
Fpdf::SetX(63);
...
Fpdf::Cell(20, 6, 'Volume', 1, 0, 'C');
Fpdf::Cell(75, 6, 'Note', 1, 1, 'C');

Fpdf::SetFont('Arial', '', 10);
// Table with 20 rows and 4 columns
Fpdf::SetWidths(array(10, 45, 40, 20, 75));
Fpdf::SetAligns(array('C', 'C', 'C', 'C', 'L'));
$no = 0;
foreach ($samples as $sample) {
    $no++;
    Fpdf::Row([
...
Fpdf::SetY($yttd + 3);
Fpdf::SetFont('Arial', '', 10);
Fpdf::Cell(190, 6, 'Palangka Raya, ' . indonesianDate(date('d F Y', strtotime($kesmas->order_date))), 0, 1, 'R');
Fpdf::Cell(95, 6, 'Diberikan Oleh,', 'LTR', 0, 'C');
Fpdf::Cell(95, 6, 'Diterima Oleh,', 'LTR', 1, 'C');
Fpdf::Cell(95, 20, '', 'LR', 0, 'C');
Fpdf::Cell(95, 20, '', 'LR', 1, 'C');
Fpdf::Cell(95, 6, '( ' . $review->reviewer . ' )', 'LBR', 0, 'C');
Fpdf::Cell(95, 6, '( ' . ucfirst($customers->customer_pic) . ' )', 'LBR', 1, 'C');

// TOTAL PAGE
Fpdf::AliasNbPages();
Fpdf::Output('FPPS -' . $kesmas->order_code . '.pdf', 'I');
exit();