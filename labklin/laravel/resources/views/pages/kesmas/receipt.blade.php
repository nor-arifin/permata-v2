...
Fpdf::Cell(5, 6, ':', 0, 0, 'C');
Fpdf::Cell(155, 6, date('d - m - Y', strtotime($kesmas->created_at)), 0, 1, 'L');
//HEADER TABLE
fpdf::SetY(100);
fpdf::SetFont('Arial', 'B', 10);
...
$dated = $kesmas->order_payment_date == null ? now() : $kesmas->order_payment_date;
...
fpdf::Cell(5, 6, ':', 0, 0, 'L');
fpdf::Cell(60, 6, $kesmas->order_payment_method . ' at ' . $kesmas->order_payment_date, 0, 0, 'L');
fpdf::SetFont('Arial', 'B', 10);
fpdf::Cell(60, 6, 'Payment Amount', 0, 0, 'R');
fpdf::Cell(30, 6, 'Rp. ' . number_format($kesmas->order_payment_amount, 0, ',', '.') . ',-', 0, 1, 'R');
//NOTES
...
fpdf::Cell(50, 6, 'Palangka Raya, ' . date('d - m - Y', strtotime($dated)), 0, 1, 'C');
...
// TOTAL PAGE
fpdf::AliasNbPages();
Fpdf::Output('Receipt Kesmas - ' . $customers->customer_name . ' - ' . $kesmas->order_code . '.pdf', 'I');
exit();