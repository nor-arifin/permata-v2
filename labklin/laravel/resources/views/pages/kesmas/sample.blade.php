                    ...
                    <div class="card-body">
                        <div id="sampledetail-wrapper">
                            <div class="form-row sampledetail">
                                ...
                                <div class="form-group col-md-2">
                                    <label for="volume">Sample Note</label>
                                    <input type="text" class="form-control" name="sample_note[]" required>
                                </div>
                                <div class="form-group col-md-2">
...
$(document).ready(function() {
    $('#division').change(function() {
        ...
        if (division === 'Kimia') {
            ...
            typeSelect.append('<option value="AH">Air Higiene dan Sanitasi</option>');
            typeSelect.append('<option value="AK">Air Kolam Renang</option>');
            typeSelect.append('<option value="AT">Air Laut</option>');
            typeSelect.append('<option value="AL">Air Limbah</option>');
            typeSelect.append('<option value="AM">Air Minum</option>');
            typeSelect.append('<option value="AU">Air Pemandian Umum</option>');
            typeSelect.append('<option value="AP">Air SPA</option>');
            typeSelect.append('<option value="AS">Air Sungai/Danau</option>');
        } else {
            ...
            typeSelect.append('<option value="AP">Air SPA</option>');
            typeSelect.append('<option value="AS">Air Sungai/Danau</option>');
            typeSelect.append('<option value="LN">Linen</option>');
            typeSelect.append('<option value="MS">Alat Masak</option>');
            typeSelect.append('<option value="MM">Makanan Minuman</option>');
            typeSelect.append('<option value="US">Usap Swab</option>');
            typeSelect.append('<option value="MT">Media Tanah</option>');
            typeSelect.append('<option value="KU">Kualitas Udara</option>');
            typeSelect.append('<option value="OL">Other</option>');
        }
    });
});
</script>
