                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control @error('location_code')
                                    is-invalid
                                @enderror" name="location_code" value="{{ $location->location_code }}" placeholder="3 Digits Unique Code" minlength="3" maxlength="3" required>
                                @error('location_code')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 mt-2">
                                <input type="text" class="form-control @error('location_name')
                                    is-invalid
                                @enderror" name="location_name" value="{{ $location->location_name }}" placeholder="Location Name" minlength="3" required>
                                @error('location_name')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 mt-2">
                                <input type="text" class="form-control @error('location_description')
                                    is-invalid
                                @enderror" name="location_description" value="{{ $location->location_description }}" placeholder="Location Description" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3 mt-2">
                                <input type="text" class="form-control @error('location_position_longitude')
                                    is-invalid
                                @enderror" name="location_position_longitude" value="{{ $location->location_position_longitude }}" placeholder="Longitude" required>
                            ...
                            <div class="col-sm-3 mt-2">
                                <input type="text" class="form-control @error('location_position_latitude')
                                    is-invalid
                                @enderror" name="location_position_latitude" value="{{ $location->location_position_latitude }}" placeholder="Latitude" required>
                            ...
                            <div class="col-sm-3 mt-2">
                                <input type="text" class="form-control @error('location_position_altitude')
                                    is-invalid
                                @enderror" name="location_position_altitude" value="{{ $location->location_position_altitude }}" placeholder="Altitude" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 mt-2">
                                <select class="form-control" name="location_physical_type" required>
                                    @php
                                        $location_physical_type = $location->location_physical_type;
                                    @endphp
                                    @if ($location_physical_type == "ro")
                                        @php
                                            $show = "Ruangan";
                                        @endphp
                                    @elseif ($location_physical_type == "bu")
                                        @php
                                            $show = "Gedung";
                                        @endphp
                                    @elseif ($location_physical_type == "wi")
                                        @php
                                            $show = "Sayap Gedung";
                                        @endphp
                                    @elseif ($location_physical_type == "area")
                                        @php
                                            $show = "Area";
                                        @endphp
                                    @endif
                                    <option value="{{ $location_physical_type }}">{{ $show }}</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 mt-2">
                                <select class="form-control" name="location_status" required>
                                    <option value="{{ $location->location_status }}">{{ ucfirst($location->location_status) }}</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 mt-2">
                                <input type="text" class="form-control @error('location_organization')
                                    is-invalid
                                @enderror" name="location_organization" value="{{ $location->location_organization }}" placeholder="Location Organization" readonly>
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 mt-2 col-form-label">ID Location</label>
                            <div class="col-sm-9 mt-2">
                                <input type="text" class="form-control @error('location_uuid')
                                    is-invalid
                                @enderror" name="location_uuid" value="{{ $location->location_uuid }}" placeholder="Location ID" readonly>
                                @error('location_uuid')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
