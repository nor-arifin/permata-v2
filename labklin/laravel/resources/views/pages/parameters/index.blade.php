...
@section('title', 'Parameters Tests')
        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-button">
                    <a href="{{ route('parameter.create') }}" class="btn btn-primary">Add New</a>
                </div>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
                    <div class="breadcrumb-item"><a href="#">Parameters Test</a></div>
                    <div class="breadcrumb-item">All Parameters Test</div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>All Parameters Tests</h4>
                                <div class="card-header-action">
                                    <a href="{{ route('export.parameter') }}" class="btn btn-success"><i
                            ...
                            <div class="card-body">
                                <div class="float-right">
                                    <form method="GET" action="{{ route('parameter.index') }}">
                                    ...
                                    <table class="table-striped table">
                                        ...
                                        @foreach ($parameters as $data)
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <strong>{{ $data->parameter_name }}</strong>
                                                                                </td>
                                                                                <td class="text-center">
                                                                                    {{ $data->parameter_group }} - {{ $data->parameter_subgroup }}
                                                                                </td>
                                                                                <td class="text-center">
                                                                                    {{ $data->parameter_method }}
                                                                                </td>
                                                                                <td class="text-center">
                                                                                    {{ $data->parameter_category }} Test
                                                                                </td>
                                                                                <td class="text-left">
                                                                                    @php
                                                                                ...
                                                                                <td class="text-center">
                                                                                    @if ($data->parameter_status == 'active')
                                                                                        <div class="badge badge-pill badge-success float-right mb-1">
                                                                                            {{ ucfirst($data->parameter_status) }}
                                                                                        </div>
                                                                                    @elseif ($data->parameter_status == 'inactive')
                                                                                ...
                                                                                <td>
                                                                                    <div class="d-flex justify-content-center">
                                                                                        <a href='{{ route('parameter.edit', $data->id) }}'
                                                                                            class="btn btn-sm btn-warning btn-icon">
                                                                                            <i class="fas fa-edit"></i>
                                                                                        </a>
                                                                                        <button class="btn btn-sm btn-danger btn-icon confirm-delete ml-2"
                                                                                            data-toggle="modal" data-target="#deleteModal{{ $data->id }}"><i
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Do you really to test master {{ $data->parameter_name }} ? This process will detele the test and
                            subtest from database.</p>
                    </div>
                    <div class="modal-footer bg-whitesmoke br">
                        <form action="{{ route('laboratory.destroy', $data->id) }}" method="POST" class="ml-2">
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="importModal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('import.parameter') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
